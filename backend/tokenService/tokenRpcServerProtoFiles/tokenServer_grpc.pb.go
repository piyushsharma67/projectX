...
func (c *tokenValidationClient) GenerateToken(ctx context.Context, in *GenerateTokenRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	out := new(TokenResponse)
	err := c.cc.Invoke(ctx, "/tokenRpcServerProtoFiles.TokenValidation/GenerateToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tokenValidationClient) ValidateToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	out := new(TokenResponse)
	err := c.cc.Invoke(ctx, "/tokenRpcServerProtoFiles.TokenValidation/ValidateToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTokenValidationServer) GenerateToken(context.Context, *GenerateTokenRequest) (*TokenResponse, error) {
...
func _TokenValidation_GenerateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TokenValidationServer).GenerateToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tokenRpcServerProtoFiles.TokenValidation/GenerateToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenValidationServer).GenerateToken(ctx, req.(*GenerateTokenRequest))
	}
...
func _TokenValidation_ValidateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tokenRpcServerProtoFiles.TokenValidation/ValidateToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TokenValidation_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tokenRpcServerProtoFiles.TokenValidation",
	HandlerType: (*TokenValidationServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GenerateToken",
			Handler:    _TokenValidation_GenerateToken_Handler,
		},
		{
